...
<i>Indice de Proyectos</i>
<ul>
<li><a href="https://github.com/GutiLebron/Repository_Abap_Cloud_Ejercicios/tree/main/src/zpackage_table_crud_productos">CRUD Productos</a>
...
<p>Desarrollo de un RAP donde se le implementa una <strong>Validation</strong> donde solo permite modificar el número de páginas al crear, una <strong>Determination</strong> según el número de páginas añade uno u otro estado del libro y modificación del archivo <strong>Metadata</strong></p></li>
</ul>
